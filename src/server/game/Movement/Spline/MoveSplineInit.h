...
namespace Movement
{
    ...
    inline void MoveSplineInit::SetWalk(bool enable) { args.walk = enable; args.flags.walkmode = enable; } //Lanny Fix SMART_ACTION_FOLLOW broken on 1-16-26 by commit 24410
